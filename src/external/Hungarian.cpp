...
//********************************************************//
    float HungarianAlgorithm::Solve(vector<vector<float>> &DistMatrix, vector<int> &Assignment)
    {
        float cost = 0.0f;
        ...
        // Here the cost matrix of size MxN is defined as a single precision array of N*M elements.
