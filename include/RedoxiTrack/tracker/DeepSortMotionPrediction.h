...
{
class REDOXI_TRACK_API DeepSortMotionPrediction : public MotionPredictionByKalman
{
  public:
    /**
...
using DeepSortMotionPredictionPtr = std::shared_ptr<DeepSortMotionPrediction>;
} // namespace RedoxiTrack
